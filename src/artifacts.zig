...
pub fn validStatus(artifact_type: []const u8, status: []const u8) bool {
    ...
    if (std.mem.eql(u8, artifact_type, "meeting_note") or std.mem.eql(u8, artifact_type, "research") or std.mem.eql(u8, artifact_type, "incident_report") or std.mem.eql(u8, artifact_type, "page")) {
